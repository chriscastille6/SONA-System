...
urlpatterns = [
    ...
    path('hr-sjt/consent-doc/<str:kind>/', views.hr_sjt_static_consent_doc, name='hr_sjt_static_consent_doc'),
    path('hr-sjt/exempt-request/', views.hr_sjt_exempt_request_doc, name='hr_sjt_exempt_request_doc'),
