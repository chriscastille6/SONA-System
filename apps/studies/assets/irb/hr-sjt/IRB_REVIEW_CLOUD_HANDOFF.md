...
| Official rev9 exempt form (filled) | `HSIRB_EXEMPT_REVIEW_REQUEST.pdf` (+ `.md` field map) | Overlay on `HSIRB-exempt_review_request.rev9_2019.v2_BLANK.pdf`; rebuild: `python3 scripts/fill_hr_sjt_hsirb_exempt_form.py` |
