# HR Situational Judgment Test – Tailored Protocol for PRAMS Entry

**Study:** HR Situational Judgment Test: Evidence-Based HR Decision-Making  
**Study slug:** hr-sjt  
**Suggested reviewers:** Jon Murphy (CBA), Juliann Allen  
**Dates:** Start ~2 weeks from submission; completion ~6 months from start
...
1. To measure how students evaluate HR management tactics in situational judgment scenarios
2. To identify which tactics students rate as most and least effective across key HR domains
3. To examine whether training in evidence-based HR practices shifts tactic ratings (if pre/post design is used)
4. To contribute to understanding of HR education and situational judgment assessment in business curricula

**Research Questions:**
1. How do students rate the effectiveness of HR tactics across scenarios (e.g., workplace accommodations, remote work, BFOQ)?
2. Are there significant differences in ratings between tactics within scenarios?
3. Does training in evidence-based HR practices change students’ tactic ratings?
4. What patterns of tactic preference emerge across HR domains?

**Educational Justification:**
This research serves educational purposes by:
- Providing students with hands-on experience in HR situational judgment assessment
- Teaching students about evidence-based HR management and its measurement
- Demonstrating research methodology and data collection procedures
- Contributing to students’ understanding of HR decision-making in organizational contexts
...
- Other students and researchers interested in HR education and situational judgment
- Educators developing HR training programs
- Organizations seeking to understand HR assessment and evidence-based decision-making

**Benefits to Society:**
This research contributes to:
- Scientific understanding of HR situational judgment as a measure of decision-making
- Understanding of evidence-based HR practices in educational settings
- Development of better HR assessment and training methods
...
5. Support resources: Participants are provided with resources for further learning about HR management if they are interested.
...
Data will be collected through the PRAMS online platform and the HR SJT web application using the following methods:

1. Participant identification: Participant ID generated from name (no names stored)
...
4. Limited data sharing: Data will only be shared in aggregated, anonymized form for publication purposes. Individual participant data will be shared but in anonymized form.
...
- Principal Investigator (Dr. Christopher Castille)
...
- **PI Phone:** 985-449-7015 (or 337-256-0664)
...
**Vulnerable Populations:** false  
**International Research:** false  
**Financial Interests:** None to disclose  
**Monitoring & Oversight:** Standard IRB monitoring  
**Publication & Dissemination:** Individual participant data will be shared but in anonymized form  
**Appendices:** HR SJT instrument description; consent form; recruitment copy  
**Contact Information:** PI: Dr. Christopher Castille, christopher.castille@nicholls.edu, 985-449-7015; IRB: Dr. Alaina Daigle, 985-448-4697
...
- [x] Update PI title and department
- [x] Include "opt out" button mention in consent procedures
- [x] Mention OSF in data retention
- [x] Update IRB contact to Dr. Alaina Daigle
- [x] Customize research-specific sections
- [x] Ensure all language is consistent with exempt status justification
